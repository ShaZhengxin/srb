...
import com.szx.srb.core.service.IntegralGradeService;
...
public class AdminIntegralGradeController {
    ...
    @ApiOperation(value = "根据id删除数据记录",notes = "逻辑删除数据记录")//value是简要说明  notes是详细说明
    @DeleteMapping("/remove/{id}")
    public R removeById(
            @ApiParam(value = "数据id",example = "3",required = true)
